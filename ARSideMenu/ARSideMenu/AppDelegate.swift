...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    var window: UIWindow?
    var sideMenuContainerViewController:ARSideMenuContainerViewController?
    ...
    func setUpSideMenuNavigation(){
        //Setting central and left View Controllers
        let storyBoard = UIStoryboard(name: "Main", bundle: nil)
        sideMenuContainerViewController = storyBoard.instantiateViewController(withIdentifier:"sideMenuContainerVC") as? ARSideMenuContainerViewController
